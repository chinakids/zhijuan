...
writeFileSync(
  ...
  [
    ...
    `let items = [`,
    `  { target: '人物/林晓.md', anchor: '基础档案', kind: 'upsert-section', before: '原档案无本章行动', after: '- 本幕动向：主动靠近韩青；踏水走向对方\\n- 状态下限：穿大衣、赤足踩水', reason: '本章行动' },`,
    ...
    `check('上下文含上一章尾部（承接前情）', all.includes('踏水走向刚下班的韩青'))`,
    `check('人物存档切片状态进入上下文', all.includes('主动靠近韩青') && all.includes('本幕动向'))`,
