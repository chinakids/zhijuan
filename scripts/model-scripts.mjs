...
export const REVIEWED_NON_MODEL = new Set([
  ...
  // 2026-09-22 10:3x 平台层轮核对：sync-serialize-ui-smoke.mjs 是无头 UI 冒烟（CDP 9224 + devShim 内存 mock 页面，
  // 用 ?zj-syncdelay=N 注入 agentSync mock 延迟，断言「同章同步在途→新保存排队、完成后串行补跑」；
