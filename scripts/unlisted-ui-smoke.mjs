...
try {
  ...
  // 提示卡出现：含「未列入「涉及人物」」与「沈爷」「沈藏」
  await evalUntil(page, `document.body.innerText.includes('未列入「涉及人物」')`, (v) => v === true, 12000, '提示卡出现')
  ...
  const cardGone = await page.eval(`!document.body.innerText.includes('未列入「涉及人物」')`)
